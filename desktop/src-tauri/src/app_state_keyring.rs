...
mod tests {
    ...
    #[test]
    fn candidate_scope_never_shares_the_release_identity() {
        let candidate = "buzz-desktop-candidate.peakhunter";
        assert_ne!(candidate, "buzz-desktop");
        assert_eq!(
            migration_marker_name(candidate, "identity.migrated"),
            "identity.buzz-desktop-candidate.peakhunter.migrated"
        );
    }
